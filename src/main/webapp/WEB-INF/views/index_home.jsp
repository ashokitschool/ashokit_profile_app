                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">Ashok IT</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">Ashok IT is an IT Educational Institute Established in 2020 and this Institute offers world class quality of education and wide range of courses. Ashok IT Institute has a dedicated placement team to help students get job placement in various IT job roles with major companies.
	    </p>
	    <p><strong>Address:</strong>   H.No - 7-1-413/2, Beside Sonabhai Temple, Ameerpet, Hyderabad - 500016</p>
	    <p><strong>Ph No: </strong>  +91 - 9985296677 </p>
		<p><strong>E-Mail ID :</strong> info@ashokitech.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2023 <a href="#"  target="_blank" class="w3-hover-text-green">ashokitech.com</a></p>
</footer>
